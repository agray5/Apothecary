...
/********** Objects ***********/
        ...
        let comb = Item("comb", 2, "Without this you'd always have a bad hair day.", "A small comb lays on the ground", 4, "none", null,  null, true, true);
        ...
        let bedRoom = Room("Bedroom", "img/bedroom.png", "Your new mentor gives you a gentle smile as she turns to leave you to get settled in your new room. Suddenly exhausted you take a seat on your bed. "
            ...
            +"bed coverings, fingers slowly kneading into them like a kitten searching for milk. This was life, the royalty owned the commoners. They could only hope that their ruler's guidance lead to prosperity. You look around your room with a sigh. "
            +"Its true that its no smaller than what you are use to back home, you did after all share a room of similar size with your sister, but its feels empty and lonely. "
            +"The bed is covered in a plain spread with white sheets and a brown thin looking blanket. Your new desk is unadorned, just waiting to be covered in knick-knacks and work forms. You spend the rest of the day unpacking your meager belongings and end the day with "
            +"a bath in your private wooden wash basin in the corner of the room. You appreciate the plain divider hiding you from the view of the door.",
        "Your bedroom is on the small side but at least its been furnished with a desk and a bed along the east wall. In the opposite corner a plain divider hides a wooden wash basin. A door to the north leads out into the hallway.");
        ...
        let lobby = Room("Lobby", "img/lobby.jpg", null, "This room could easily fit hundred people all scurrying to complete one task or another. It was rare to see any royalty come this way as this is considered to be an extension of the castle workers living quarters. " +
            " It would be hard to complain though. Rays of sunlight stream through the high widows and sometimes small birds would fly in, chirping a merry song. The smell of freshly made food could be smelt from the nearby kitchen.", null, null, "This room could easily fit hundred people all scurrying to complete one task or another. It was rare to see any royalty come this way as this is considered to be an extension of the castle workers living quarters. " +
            " It would be hard to complain though. The hall looked breathtaking at night. Streams of cool moonlight filter in through the widows, while colorful lanterns have been lit along the walls bathing the hall in a myriad of colors.");
        ...
        [`So you must be the famous ${player.getName()}. I am Aierith, the apothecary master of the castle. I am in charge of the apothecary room and making sure all the royal medicine needs are met. `,
